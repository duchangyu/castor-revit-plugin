...
using CastorPlugin.Core.OpenRevitOleStorage.Common;
using System;
...
namespace CastorPlugin.Core.OpenRevitOleStorage.StructuredStorage
{
    ...
    public class BasicFileInfo : StorageStreamBase
    {
        ...
        public ProductType Product
        {
            get
            {
                ...
                if (RevitBuild.IndexOf("MEP", StringComparison.CurrentCultureIgnoreCase) >= 0)
                {
                    return ProductType.MEP;
                }

                if (RevitBuild.IndexOf("ARCHITECTURE", StringComparison.CurrentCultureIgnoreCase) >= 0)
                {
                    return ProductType.Architecture;
                }

                if (RevitBuild.IndexOf("STRUCTURE", StringComparison.CurrentCultureIgnoreCase) >= 0)
                {
        ...
        public PlatformType Platform
        {
            get
            {
                ...
                if (RevitBuild.IndexOf("X64", StringComparison.CurrentCultureIgnoreCase) >= 0)
                {
